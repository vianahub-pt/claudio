                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {submitMessage && (
                    <div
                      ...
                      style={{
                        backgroundColor: submitMessage.includes("sucesso") ? "#dcfce7" : "#fee2e2",
                        color: submitMessage.includes("sucesso") ? "#15803d" : "#dc2626",
                      }}
                    >
                      {submitMessage}
                    </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center">
                  <div className="!bg-blue-100 p-4 rounded-lg mb-4 inline-block" style={{ backgroundColor: "#dbeafe" }}>
                    <svg
                  ...
                  <h3 className="!text-blue-700 font-semibold text-lg mb-2" style={{ color: "#1d4ed8" }}>
                    WhatsApp
                  </h3>
                ...
                <div className="text-center">
                  <div className="!bg-blue-100 p-4 rounded-lg mb-4 inline-block" style={{ backgroundColor: "#dbeafe" }}>
                    <Mail className="!text-blue-600" size={32} style={{ color: "#2563eb" }} />
                  </div>
                  <h3 className="!text-blue-700 font-semibold text-lg mb-2" style={{ color: "#1d4ed8" }}>
                    Email
                  </h3>
                ...
                <div className="text-center">
                  <div className="!bg-blue-100 p-4 rounded-lg mb-4 inline-block" style={{ backgroundColor: "#dbeafe" }}>
                    <MapPin className="!text-blue-600" size={32} style={{ color: "#2563eb" }} />
                  </div>
                  <h3 className="!text-blue-700 font-semibold text-lg mb-2" style={{ color: "#1d4ed8" }}>
                    Morada
                  </h3>
                ...
                <div className="text-center">
                  <div className="!bg-blue-100 p-4 rounded-lg mb-4 inline-block" style={{ backgroundColor: "#dbeafe" }}>
                    <Clock className="!text-blue-600" size={32} style={{ color: "#2563eb" }} />
                  </div>
                  <h3 className="!text-blue-700 font-semibold text-lg mb-2" style={{ color: "#1d4ed8" }}>
